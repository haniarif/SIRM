...
<?php		
	$query = mysql_query("SELECT * FROM mutasi z where z.id_mutasi=$_GET[id_mutasi]") or die(mysql_error());
	...
	where z.id_pendftrn=$data[id_pendftrn]") or die(mysql_error());
	...
	where b.id_pendftrn=$data[id_pendftrn]") or die(mysql_error());
	?>
