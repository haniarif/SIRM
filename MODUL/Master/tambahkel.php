		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					...
					<!-- Table -->
					<div class="table">
					<form method="post" action="tambahkeL.php" class="form">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td>Nama Kecamatan</td>
									<td colspan="3">
									<input type="text" name="id_kecamatan" id="input_data" size="50" placeholder="require">
									<script type='text/javascript'>
								...
								<td>Nama Kelurahan</td>
									<td colspan="3">: <input type="text" name="nama_kelurahan" size="50" placeholder="require"></td>
								</tr>
								<tr>
									<td>Kode</td>
									<td colspan="3">: <input type="text" name="kode_kel" size="50" placeholder="require"></td>
								</tr>
								<tr>
									<td></td>
...
if (isset($_POST['submit'])){
	mysql_query("insert into kelurahan (id_kelurahan, id_kecamatan,  nama_kelurahan, kode_kel) 
			values ('','$_POST[id_kecamatan]', '$_POST[nama_kelurahan]','$_POST[kode_kel]')");
