...
$id = $_GET['id_provinsi'];
$sql = mysql_query ("select * from provinsi where id_provinsi = '$id'") or die(mysql_error());
		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					...
					<!-- Table -->
					<form method="post" action="editprov.php">
							<table border="0" cellspacing="0" cellpadding="5" width="95%" class="form">
								<tr>
									<td> &nbsp; </td>
									<td><input type='hidden' name='id_provinsi' value='<?php echo $data['id_provinsi'];?>'/></td>
								</tr>
								<tr>
									<td width="150">Nama</td>
									<td colspan="3">: <input type="text" name="nama_provinsi" size="50" value="<?php echo $data['nama_provinsi'];?>"></td>
								</tr>
								<tr>
									<td>Kode</td>
									<td colspan="3">: <input type="text" name="kode_prov" size="50" value="<?php echo $data['kode_prov'];?>"></td>
								</tr>
								<tr>
									<td></td>
...
<?php
	...
	$query=mysql_query("update provinsi set nama_provinsi = '$nama_provinsi',
					kode_prov = '$kode_prov'
					where id_provinsi = '$id' ") or die(mysql_error());
