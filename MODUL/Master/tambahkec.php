		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					...
					<!-- Table -->
					<div class="table">
					<form method="post" action="tambahkec.php" class="form">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td>Nama Kabupaten</td>
									<td colspan="3">
									<input type="text" name="id_kabupaten" id="input_data" size="50" placeholder="require">
								...
								<td>Nama Kecamatan</td>
									<td colspan="3">: <input type="text" name="nama_kecamatan" size="50" placeholder="require"></td>
								</tr>
								<tr>
									<td>Kode</td>
									<td colspan="3">: <input type="text" name="kode_kecamatan" size="50" placeholder="require"></td>
								</tr>
								<tr>
									<td></td>
...
if (isset($_POST['submit'])){
	mysql_query("insert into kecamatan (id_kecamatan, id_kabupaten, nama_kecamatan,kode_kecamatan) 
			values ('', '$_POST[id_kabupaten]', '$_POST[nama_kecamatan]','$_POST[kode_kecamatan]')");
