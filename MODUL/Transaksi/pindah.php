				...
				<div class="box">
					...
					<div class="table">
						...
						<table>
							<tr>
								<td> No. RM </td>
								<td><input type="text" name="no_rm" id="input_data"><input type="hidden" name="id_mutasi" id="id_mutasi">
									...
									function get_mutasi(no_rm){
										$.ajax({
											...
											success: function(data){
												...
												$('#id_pendftrn').val(mutasi.id_mutasi);
												$('#nama_kamar').val(mutasi.nama_kamar);
												$('#tgl_masuk').val(mutasi.tgl_masuk);
							...
							<tr>
								<td> TANGGAL MASUK </td>
								<td><input type='date' name='tgl_masuk' class="isi"/></td>
							</tr>
							<tr>
							...
							<tr>
								<td> KAMAR AWAL </td>
								<td><input type='text' name='nama_kamar' id="nama_kamar" /></td>
							</tr>
							<tr>
								<td> KAMAR </td>
...
if (isset($_POST['submit'])){
	...
	mysql_query("insert into mutasi (id_mutasi, id_pendftrn, id_pengguna, id_dokter, id_kamar, tgl_masuk, tgl_keluar, status) 
			values ('','$_POST[id_pendftrn]', '$_POST[id_pengguna]', '$_POST[id_dokter]', '$_POST[id_kamar]', '$_POST[tgl_masuk]', '$_POST[tgl_keluar]', '$_POST[status]')") or die(mysql_error());
